	...
	$.fn.coinslider= $.fn.CoinSlider = function(options){
		...
		$.setNavigation = function(el){
			...
			$('#cs-prev-'+el.id).css({
				...
				$.transition(el,'prev');
				$.transitionCall(el);		
			}).hover(function(){$(this).stop().animate({left:'-70'},200,'easeOutBack')},function(){$(this).stop().delay(200).animate({left:'-65'},200,'easeInBack')})
			...
			$('#cs-next-'+el.id).css({
				...
				$.transition(el);
				$.transitionCall(el);
			}).hover(function(){$(this).stop().animate({right:'-75'},200,'easeOutBack')},function(){$(this).stop().delay(200).animate({right:'-70'},200,'easeInBack')})
		}
